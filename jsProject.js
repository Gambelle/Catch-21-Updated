...
let catch21=false;
let audio = new Audio('ElevatorMusic.mp3');
...
canvas.addEventListener("mousedown", function(e)
{
  ...
  //when play music is clicked will start audio
  if(xMouse>805&&xMouse<925&&yMouse>30&&yMouse<60)
  {
    if(isMusic==false){
      playBackgroundM();
      isMusic=true;
  ...
  //when paused music is clicked will pause audio
  if(xMouse>805&&xMouse<925&&yMouse>75&&yMouse<100)
  {
    if(isMusic==true){
      pauseBackgroundM();
      isMusic=false;
...
//music/sound effects
function playBackgroundM()
{
  audio.play();
}
function pauseBackgroundM()
{
  audio.pause();
}
function playCardFlipS()
{
  let sound = new Audio('Card-flip-sound-effect.mp3');
  sound.play();
}
...
function drawMenu()
{
  ...
  //draws scoring rules
  context.fillText("Scoring",950,40);
  context.fillText("777: 500",950,60);
  context.fillText("2 Card 21: 300",950,75);
  context.fillText("5 Card 21: 400",950,90);
  context.fillText("6 Card 21: 450",950,105);
  context.fillText("Regular 21: 200",950,120);
}
...
function updateHighScore()//uses local storage to store highscore data so the highscore is maintained in web browser
{
  if(totalScore>highscore)
  {
    ...
    context.fillText("Congratualtion!",80,950);
    context.fillText("New Highscore!",80,980);
  }
  else {
    drawHighscore();
  }
...
{
  context.fillStyle=offWhiteC;
  context.fillRect(75,800,250,200);
  context.strokeRect(75,800,250,200);
  context.fillStyle="black";
  context.fillText("Highscore",80,825);
  context.fillText(highscore,80,855);
}
function drawMusicOptions()
{
  context.fillStyle="GoldenRod";
  context.fillRect(805,30,120,30);
  context.strokeRect(805,30,120,30);
  context.fillStyle="black";
  context.font="12pt Calibri"
  context.fillText("Play Music",815,50);
  context.fillStyle="GoldenRod";
  context.fillRect(805,70,120,30);
  context.strokeRect(805,70,120,30);
  context.fillStyle="black";
  context.fillText("Pause Music",815,90);
}
